...
app.get('/weather', function(req, res) {
  ...
  weather.find({search: zipCode, degreeType: 'F'}, function(err, result) {
    ...
    res.render('results.ejs', { messageRand: "Hi I'm the server, and this is the weather location info I found for you. Enjoy!", 
                                message: "Hi I'm the server, tell me your zip code and I'll show you forecast and weather information.",
...
function findWheather(zip){
  ...
  if(err) { console.log(err) } 
    if(result.length === 0) {
      ...
      app.get('/', (req, res) => {
        res.render('index.ejs', { messageRand: "Hi I'm the server, and this is random weather location info I found for you. Enjoy!", 
                                  message: "Hi I'm the server, tell me your zip code and I'll show you forecast and weather information.", 
                                  locationData: locationData, 
                                  currentData: currentData, 
                                  forecastData: forecastData } )
